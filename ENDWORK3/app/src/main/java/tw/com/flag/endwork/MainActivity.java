...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btn_add, btn_subtract, btn_multiply, btn_divide, btn_point,btn_jiecheng,btn_square,btn_cube;          //按钮 + - × ÷ .
    private Button btn_backspace, btn_ce, btn_lr, btn_cursor,btn_weijie;      //按钮 backspace CE ( ) |
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            btn_jiecheng= (Button) findViewById(R.id.button_jiecheng);
            btn_square=(Button) findViewById(R.id.button_square);
            btn_cube=(Button) findViewById(R.id.button_cube);
            btn_weijie=(Button) findViewById(R.id.button_weijie);
            //为按钮添加监听器
            ...
            btn_jiecheng.setOnClickListener(listener);
            btn_cube.setOnClickListener(listener);
            btn_square.setOnClickListener(listener);
            btn_weijie.setOnClickListener(listener);
        }
    }
